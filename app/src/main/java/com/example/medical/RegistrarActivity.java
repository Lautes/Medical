        ...
        bt_registrar.setOnClickListener (new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.equals("")){
                    ...
                    Toast.makeText(RegistrarActivity.this,"As duas senham não se correspondem, tente novamente", Toast.LENGTH_SHORT).show();
                }
                else{
                    //OKAY
                    long res = db.CriarUtilizador(username,p1);
                    if (res > 0){
                        Toast.makeText(RegistrarActivity.this,"Cadastrado!", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(RegistrarActivity.this,"Registro inválido, tente novamente", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
